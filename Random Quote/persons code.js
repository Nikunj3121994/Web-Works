...
function getQuote() {
  $.ajax({
	...
	//website response.. if succesfful fo everything in function
    success: function(response) {
	  //parse response as a json object
      var r = JSON.parse(response);
	  
	  //get the parts needed i.e author and quote
      currentQuote = r.quote;
      currentAuthor = r.author;
	  
	  // set attribute of  twitter button and tumblr button
      if(inIframe())
      {
...
$(document).ready(function() {
  // page loads -> get a quote
  getQuote();
  // button clicked get a new quote
